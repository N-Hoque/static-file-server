...
- Docker Hub: https://hub.docker.com/r/N-Hoque/static-file-server/
- GitHub: https://github.com/N-Hoque/static-file-server
...
docker run -d \
    -v /my/folder:/web \
    -p 8080:8080 \
    nhoque/static-file-server:latest
```
...
./serve help
# OR
docker run -it nhoque/static-file-server:latest help
```
